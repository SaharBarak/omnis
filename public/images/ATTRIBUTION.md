...
This file lists all images that require attribution under their respective licenses.

## License Types Used

- **MIT** - Free to use, modify, distribute. No attribution required.
- **CC0** - Public domain. No attribution required.
- **CC-BY** - Free to use with attribution required.
- **CC-BY-SA** - Free to use with attribution, share-alike required.

---

## Attributions by Category
...
- Files: 01-aries.svg through 12-pisces.svg
- URL: https://commons.wikimedia.org/wiki/Category:SVG_astrological_symbols

**Planet Symbols** (`/astrology/planets/`)
- Source: Wikimedia Commons
- License: Public Domain (CC0)
- Files: sun.svg, moon.svg, mercury.svg, venus.svg, mars.svg, jupiter.svg, saturn.svg, uranus.svg, neptune.svg, pluto.svg
- URL: https://commons.wikimedia.org/wiki/Category:SVG_astrological_symbols
...
**Hebrew Letters** (`/gematria/letters/`)
- Source: Wikimedia Commons
- License: CC-BY-SA 3.0
- Authors: Various contributors
- Files: 01-aleph.svg through 22-tav.svg
- URL: https://commons.wikimedia.org/wiki/Category:Hebrew_letters

**Tree of Life / Sefirot** (`/gematria/sefirot/tree-of-life.svg`)
- Source: Wikimedia Commons
- Author: Elborgo
- License: CC-BY-SA 3.0
- URL: https://commons.wikimedia.org/wiki/File:Kabbalistic_Tree_of_Life_(Sephiroth).svg

### Dreamspell

**Mayan Day Signs / Seals** (`/dreamspell/seals/`)
- Source: Wikimedia Commons
- License: CC-BY-SA 3.0
- Authors: Various contributors
- Files: 01-dragon.svg (Imix) through 20-sun.svg (Ahau)
- URL: https://commons.wikimedia.org/wiki/Category:SVG_Maya_glyphs
...
When using CC-BY-SA licensed images (Hebrew letters, Tree of Life, Mayan Day Signs), you must:
1. Give appropriate credit to the original creators
