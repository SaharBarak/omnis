...
CF_SECRETS=(
  ...
  RESEND_API_KEY GEMINI_API_KEY TURNSTILE_SECRET_KEY
  PADDLE_ENV PADDLE_API_KEY PADDLE_WEBHOOK_SECRET
  PADDLE_PRICE_COMPLETE PADDLE_PRICE_PRACTITIONER PADDLE_PRICE_EXPLORER PADDLE_PRICE_LIFETIME
)
...
GH_SECRETS=(
  ...
  NEXT_PUBLIC_PADDLE_CLIENT_TOKEN NEXT_PUBLIC_CF_BEACON_TOKEN
