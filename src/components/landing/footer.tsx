    ...
    <footer className="border-t border-border bg-background">
      <div className="max-w-content mx-auto px-6 py-14 lg:py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="group flex items-center gap-2.5 mb-4">
              ...
              <span className="text-lg font-heading text-foreground group-hover:text-primary transition-colors duration-200">Pleiad</span>
            </Link>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 border-t border-border">
          <p className="text-sm text-muted-foreground">&copy; 2026 Pleiad. All rights reserved.</p>
