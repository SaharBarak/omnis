...
export function LetterBreakdownDisplay({
  ...
  return (
    <div className={cn('bg-card border rounded-lg p-4', className)} dir="rtl">
      <h4 className="text-sm font-medium mb-3 text-center">Letter Breakdown</h4>
      <div className={cn(
...
export function MethodValuesDisplay({
  ...
  return (
    <div className={cn('bg-card border rounded-lg p-4', className)}>
      <h4 className="text-sm font-medium mb-3 text-center">Calculation Methods</h4>
...
export function NameComparisonDisplay({
  ...
  return (
    <div className={cn('bg-card border rounded-lg p-4', className)}>
      <h4 className="text-sm font-medium mb-4 text-center">Name Comparison</h4>
