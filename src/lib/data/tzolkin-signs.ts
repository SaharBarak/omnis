import type { TzolkinDaySign } from '../types/tzolkin.ts'
...
export const TZOLKIN_SIGNS: readonly TzolkinDaySign[] = Object.freeze([
  ...
  { number: 7,  yucatec: "Manik'",   english: 'Deer',      hebrew: 'יד' },
  { number: 8,  yucatec: 'Lamat',    english: 'Rabbit',    hebrew: 'כוכב' },
  { number: 9,  yucatec: 'Muluk',    english: 'Water',     hebrew: 'ירח' },
  { number: 10, yucatec: 'Ok',       english: 'Dog',       hebrew: 'כלב' },
  { number: 11, yucatec: 'Chuwen',   english: 'Monkey',    hebrew: 'קוף' },
  { number: 12, yucatec: "Eb'",      english: 'Road',      hebrew: 'אדם' },
  ...
  { number: 18, yucatec: "Etz'nab'", english: 'Flint',     hebrew: 'מראה' },
  { number: 19, yucatec: 'Kawak',    english: 'Storm',     hebrew: 'סערה' },
  { number: 20, yucatec: 'Ajaw',     english: 'Lord',      hebrew: 'שמש' },
])
