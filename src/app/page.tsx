...
export const metadata: Metadata = {
  ...
  description:
    'Save the people in your life, read each person through six symbolic systems, compare pairs, and explore group patterns. Start with a free Dreamspell reading—no account required.',
  alternates: {
    canonical: '/',
  },
  openGraph: {
