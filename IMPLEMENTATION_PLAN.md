...
- **Automated Tests Added**: 66 unit tests covering Dreamspell, Tzolkin, Oracle, and Julian day calculations. Tests verify against spec validation dates (epoch, Long Count end).
